...
public interface UserRewardRepo extends CrudRepository<UserReward, Long> {
	...
	List<UserReward> findTop5ByRefOrderIdAndRewardStatusOrderByCreatedDateDesc(Long refOrderId,
                                                                               Integer rewardStatus);
	...
	List<UserReward> findByRefUserIdAndRewardDateBetweenAndRewardStatus(Long refUserId, Date startDate,

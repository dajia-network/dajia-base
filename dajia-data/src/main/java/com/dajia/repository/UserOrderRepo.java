...
public interface UserOrderRepo extends CrudRepository<UserOrder, Long> {
	...
	Page<UserOrder> findByUserIdNotAndIsActiveOrderByOrderDateDesc(Long userId, String isActive,
                                                                   Pageable pageable);

	Page<UserOrder> findByOrderStatusInAndIsActiveOrderByOrderDateDesc(List<Integer> orderStatusList,
                                                                       String isActive, Pageable pageable);

	Page<UserOrder> findByOrderStatusInAndUserIdNotAndIsActiveOrderByOrderDateDesc(
